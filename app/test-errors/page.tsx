...
export default async function TestErrorsPage({
  ...
  return (
    <>
      <div className='fixed inset-x-0 top-0 z-50 border-b border-border bg-card/95 backdrop-blur-sm'>
        <div className='mx-auto flex max-w-md items-center justify-center gap-2 p-3'>
          {previewLinks.map(({ href, label, global: globalValue }) => (
            <Link
              ...
              href={href}
              className={cn(
                'rounded-xl px-3 py-1.5 text-xs font-bold uppercase tracking-wide transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2',
